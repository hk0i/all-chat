 ...
 * — copy the `<KEY>` path segment (and update KICK_PUSHER_URL's cluster host
 * if that changed too). Community client libraries (e.g. KickLib,
 * kick-chat-wrapper on GitHub) usually track key rotations quickly and are a
 * good cross-check.
 */
export const KICK_PUSHER_KEY = '32cbd69e4b950bf97679';

/** Pusher WebSocket endpoint (protocol 7). */
export const KICK_PUSHER_URL = `wss://ws-us2.pusher.com/app/${KICK_PUSHER_KEY}?protocol=7&client=js&version=8.4.0`;
